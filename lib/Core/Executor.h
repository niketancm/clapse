...
private:
  ...
  ///a vector of ordered basic blocks in the main module
  std::vector<llvm::BasicBlock*> basicblocks;
  std::map<std::string,std::vector<int> >threadbbiidsmap;
  ...
  void printSyncTrace(std::string type);
  ...
  void initializeGlobalObject(ExecutionState &state,  ObjectState *os, 
			      ...
			      unsigned offset);
  //nikni337-GlobalMemory
  void allocateGlobalMemory(ExecutionState &state);
